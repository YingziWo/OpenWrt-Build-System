...
|ImmortalWrt|x86_64|[![immortalwrt_x86_64_23.05](https://github.com/YingziWo/OpenWrt-Build-System/actions/workflows/immortalwrt_x86_64.yml/badge.svg)](https://github.com/YingziWo/OpenWrt-Build-System/actions/workflows/immortalwrt_x86_64.yml)|23.05版本编译固件上机后，在 状态栏 ==》防火墙 项时显示提示信息。编译降级版本没有这个提示，注意版本选择。Docker需要手动挂载额外硬盘使用。|
